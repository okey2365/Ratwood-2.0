...
/mob/living/carbon/human/species/human/northern/dunewell_raider/retaliate(mob/living/L)
	var/newtarg = target
	.=..()
	if(target)
		aggressive=1
...
/mob/living/carbon/human/species/human/northern/dunewell_raider/should_target(mob/living/L)
	if(L.stat != CONSCIOUS)
		return FALSE
	. = ..()
...
/mob/living/carbon/human/species/human/northern/dunewell_raider/npc_idle()
...
/mob/living/carbon/human/species/human/northern/dunewell_raider/handle_combat()
	if(mode == NPC_AI_HUNT)
